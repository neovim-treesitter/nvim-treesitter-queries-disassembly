# nvim-treesitter-queries-disassembly

[![Validate Queries](https://github.com/neovim-treesitter/nvim-treesitter-queries-disassembly/actions/workflows/validate.yml/badge.svg)](https://github.com/neovim-treesitter/nvim-treesitter-queries-disassembly/actions/workflows/validate.yml)

Neovim tree-sitter queries for **disassembly**, part of the
...
```jsonc
{
  ...
  "url": "https://github.com/tree-sitter/tree-sitter-disassembly",
...
- [ ] Changes are scoped to `disassembly` — do not include files for other languages
